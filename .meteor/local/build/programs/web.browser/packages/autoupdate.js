                ...
                var id = Meteor.setInterval(function () {                                  // 101
                  if (link.sheet) {                                                        // 102
                    ...
                    Meteor.clearInterval(id);                                              // 104
                                                                                           ...
                                                                                           // 109
            var attachStylesheetLink = function (newLink) {                                // 110
              ...
              waitUntilCssLoads(newLink, function () {                                     // 119
                Meteor.setTimeout(removeOldLinks, 200);                                    // 120
                                                                                           ...
                                                                                           // 123
            _.each(newCss, function (css) {                                                // 124
              var newLink = document.createElement("link");                                // 125
              newLink.setAttribute("rel", "stylesheet");                                   // 126
              newLink.setAttribute("type", "text/css");                                    // 127
              newLink.setAttribute("class", "__meteor-css__");                             // 128
              newLink.setAttribute("href", css.url);                                       // 129
              attachStylesheetLink(newLink);                                               // 130
            });                                                                            // 131
          }                                                                                // 132
          else if (doc._id === 'version' && doc.version !== autoupdateVersion) {           // 133
            handle && handle.stop();                                                       // 134
            Package.reload.Reload._reload();                                               // 135
          }                                                                                // 136
        };                                                                                 // 137
                                                                                           // 138
        var handle = ClientVersions.find().observe({                                       // 139
          added: checkNewVersionDocument,                                                  // 140
          changed: checkNewVersionDocument                                                 // 141
        });                                                                                // 142
      }                                                                                    // 143
    }                                                                                      // 144
  });                                                                                      // 145
};                                                                                         // 146
Autoupdate._retrySubscription();                                                           // 147
                                                                                           // 148
/////////////////////////////////////////////////////////////////////////////////////////////
