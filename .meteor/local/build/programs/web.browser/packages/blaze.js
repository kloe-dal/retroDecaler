...
var ValueHandler = AttributeHandler.extend({                                                              // 166
  update: function (element, oldValue, value) {                                                           // 167
    if (value !== element.value)                                                                          // 168
      element.value = value;                                                                              // 169
  }                                                                                                       // 170
});                                                                                                       // 171
                                                                                                          // 172
// attributes of the type 'xlink:something' should be set using                                           // 173
// the correct namespace in order to work                                                                 // 174
var XlinkHandler = AttributeHandler.extend({                                                              // 175
  update: function(element, oldValue, value) {                                                            // 176
    var NS = 'http://www.w3.org/1999/xlink';                                                              // 177
    if (value === null) {                                                                                 // 178
      if (oldValue !== null)                                                                              // 179
        element.removeAttributeNS(NS, this.name);                                                         // 180
    } else {                                                                                              // 181
      element.setAttributeNS(NS, this.name, this.value);                                                  // 182
    }                                                                                                     // 183
  }                                                                                                       // 184
});                                                                                                       // 185
                                                                                                          // 186
// cross-browser version of `instanceof SVGElement`                                                       // 187
var isSVGElement = function (elem) {                                                                      // 188
  return 'ownerSVGElement' in elem;                                                                       // 189
};                                                                                                        // 190
                                                                                                          // 191
var isUrlAttribute = function (tagName, attrName) {                                                       // 192
  // Compiled from http://www.w3.org/TR/REC-html40/index/attributes.html                                  // 193
  // and                                                                                                  // 194
  // http://www.w3.org/html/wg/drafts/html/master/index.html#attributes-1                                 // 195
  var urlAttrs = {                                                                                        // 196
    FORM: ['action'],                                                                                     // 197
    BODY: ['background'],                                                                                 // 198
    BLOCKQUOTE: ['cite'],                                                                                 // 199
    ...
    DEL: ['cite'],                                                                                        // 201
    INS: ['cite'],                                                                                        // 202
    OBJECT: ['classid', 'codebase', 'data', 'usemap'],                                                    // 203
    APPLET: ['codebase'],                                                                                 // 204
    A: ['href'],                                                                                          // 205
    AREA: ['href'],                                                                                       // 206
    LINK: ['href'],                                                                                       // 207
    BASE: ['href'],                                                                                       // 208
    IMG: ['longdesc', 'src', 'usemap'],                                                                   // 209
    FRAME: ['longdesc', 'src'],                                                                           // 210
    IFRAME: ['longdesc', 'src'],                                                                          // 211
    HEAD: ['profile'],                                                                                    // 212
    SCRIPT: ['src'],                                                                                      // 213
    INPUT: ['src', 'usemap', 'formaction'],                                                               // 214
    BUTTON: ['formaction'],                                                                               // 215
    BASE: ['href'],                                                                                       // 216
    MENUITEM: ['icon'],                                                                                   // 217
    HTML: ['manifest'],                                                                                   // 218
    VIDEO: ['poster']                                                                                     // 219
                                                                                                          ...
                                                                                                          // 221
  if (attrName === 'itemid') {                                                                            // 222
    return true;                                                                                          // 223
  }                                                                                                       // 224
                                                                                                          // 225
  var urlAttrNames = urlAttrs[tagName] || [];                                                             // 226
  return _.contains(urlAttrNames, attrName);                                                              // 227
};                                                                                                        // 228
                                                                                                          // 229
// To get the protocol for a URL, we let the browser normalize it for                                     // 230
// us, by setting it as the href for an anchor tag and then reading out                                   // 231
// the 'protocol' property.                                                                               // 232
if (Meteor.isClient) {                                                                                    // 233
  var anchorForNormalization = document.createElement('A');                                               // 234
}                                                                                                         // 235
                                                                                                          // 236
var getUrlProtocol = function (url) {                                                                     // 237
  if (Meteor.isClient) {                                                                                  // 238
    anchorForNormalization.href = url;                                                                    // 239
    return (anchorForNormalization.protocol || "").toLowerCase();                                         // 240
  } else {                                                                                                // 241
    throw new Error('getUrlProtocol not implemented on the server');                                      // 242
  }                                                                                                       // 243
};                                                                                                        // 244
                                                                                                          // 245
// UrlHandler is an attribute handler for all HTML attributes that take                                   // 246
// URL values. It disallows javascript: URLs, unless                                                      // 247
// UI._allowJavascriptUrls() has been called. To detect javascript:                                       // 248
// urls, we set the attribute on a dummy anchor element and then read                                     // 249
// out the 'protocol' property of the attribute.                                                          // 250
var origUpdate = AttributeHandler.prototype.update;                                                       // 251
var UrlHandler = AttributeHandler.extend({                                                                // 252
  update: function (element, oldValue, value) {                                                           // 253
    var self = this;                                                                                      // 254
    var args = arguments;                                                                                 // 255
                                                                                                          // 256
    if (UI._javascriptUrlsAllowed()) {                                                                    // 257
      origUpdate.apply(self, args);                                                                       // 258
    } else {                                                                                              // 259
      var isJavascriptProtocol = (getUrlProtocol(value) === "javascript:");                               // 260
      if (isJavascriptProtocol) {                                                                         // 261
        Meteor._debug("URLs that use the 'javascript:' protocol are not " +                               // 262
                      "allowed in URL attribute values. " +                                               // 263
                      "Call UI._allowJavascriptUrls() " +                                                 // 264
                      "to enable them.");                                                                 // 265
        origUpdate.apply(self, [element, oldValue, null]);                                                // 266
      } else {                                                                                            // 267
        origUpdate.apply(self, args);                                                                     // 268
      }                                                                                                   // 269
    }                                                                                                     // 270
  }                                                                                                       // 271
});                                                                                                       // 272
                                                                                                          // 273
// XXX make it possible for users to register attribute handlers!                                         // 274
makeAttributeHandler = function (elem, name, value) {                                                     // 275
  // generally, use setAttribute but certain attributes need to be set                                    // 276
  // by directly setting a JavaScript property on the DOM element.                                        // 277
  if (name === 'class') {                                                                                 // 278
    if (isSVGElement(elem)) {                                                                             // 279
      return new SVGClassHandler(name, value);                                                            // 280
    } else {                                                                                              // 281
      return new ClassHandler(name, value);                                                               // 282
    }                                                                                                     // 283
  } else if (name === 'style') {                                                                          // 284
    return new StyleHandler(name, value);                                                                 // 285
  } else if ((elem.tagName === 'OPTION' && name === 'selected') ||                                        // 286
             (elem.tagName === 'INPUT' && name === 'checked')) {                                          // 287
    return new BooleanHandler(name, value);                                                               // 288
  } else if ((elem.tagName === 'TEXTAREA' || elem.tagName === 'INPUT')                                    // 289
             && name === 'value') {                                                                       // 290
    // internally, TEXTAREAs tracks their value in the 'value'                                            // 291
    // attribute just like INPUTs.                                                                        // 292
    return new ValueHandler(name, value);                                                                 // 293
  } else if (name.substring(0,6) === 'xlink:') {                                                          // 294
    return new XlinkHandler(name.substring(6), value);                                                    // 295
  } else if (isUrlAttribute(elem.tagName, name)) {                                                        // 296
    return new UrlHandler(name, value);                                                                   // 297
  } else {                                                                                                // 298
    return new AttributeHandler(name, value);                                                             // 299
  }                                                                                                       // 300
                                                                                                          // 301
  // XXX will need one for 'style' on IE, though modern browsers                                          // 302
  // seem to handle setAttribute ok.                                                                      // 303
};                                                                                                        // 304
                                                                                                          // 305
                                                                                                          // 306
ElementAttributesUpdater = function (elem) {                                                              // 307
  this.elem = elem;                                                                                       // 308
  this.handlers = {};                                                                                     // 309
};                                                                                                        // 310
                                                                                                          // 311
// Update attributes on `elem` to the dictionary `attrs`, whose                                           // 312
// values are strings.                                                                                    // 313
ElementAttributesUpdater.prototype.update = function(newAttrs) {                                          // 314
  var elem = this.elem;                                                                                   // 315
  var handlers = this.handlers;                                                                           // 316
                                                                                                          // 317
  for (var k in handlers) {                                                                               // 318
    if (! _.has(newAttrs, k)) {                                                                           // 319
      // remove attributes (and handlers) for attribute names                                             // 320
      // that don't exist as keys of `newAttrs` and so won't                                              // 321
      // be visited when traversing it.  (Attributes that                                                 // 322
      // exist in the `newAttrs` object but are `null`                                                    // 323
      // are handled later.)                                                                              // 324
      var handler = handlers[k];                                                                          // 325
      var oldValue = handler.value;                                                                       // 326
      handler.value = null;                                                                               // 327
      handler.update(elem, oldValue, null);                                                               // 328
      delete handlers[k];                                                                                 // 329
    }                                                                                                     // 330
  }                                                                                                       // 331
                                                                                                          // 332
  for (var k in newAttrs) {                                                                               // 333
    var handler = null;                                                                                   // 334
    var oldValue;                                                                                         // 335
    var value = newAttrs[k];                                                                              // 336
    if (! _.has(handlers, k)) {                                                                           // 337
      if (value !== null) {                                                                               // 338
        // make new handler                                                                               // 339
        handler = makeAttributeHandler(elem, k, value);                                                   // 340
        handlers[k] = handler;                                                                            // 341
        oldValue = null;                                                                                  // 342
      }                                                                                                   // 343
    } else {                                                                                              // 344
      handler = handlers[k];                                                                              // 345
      oldValue = handler.value;                                                                           // 346
    }                                                                                                     // 347
    if (oldValue !== value) {                                                                             // 348
      handler.value = value;                                                                              // 349
      handler.update(elem, oldValue, value);                                                              // 350
      if (value === null)                                                                                 // 351
        delete handlers[k];                                                                               // 352
    }                                                                                                     // 353
  }                                                                                                       // 354
};                                                                                                        // 355
                                                                                                          // 356
...
var bindIfIsFunction = function (x, target) {                                                             // 1
  ...
  return function () {                                                                                    // 4
    return x.apply(target, arguments);                                                                    // 5
                                                                                                          ...
                                                                                                          // 8
// If `x` is a function, binds the value of `this` for that function                                      // 9
// to the current data context.                                                                           // 10
var bindDataContext = function (x) {                                                                      // 11
  if (typeof x === 'function') {                                                                          // 12
    return function () {                                                                                  // 13
      var data = Blaze.getCurrentData();                                                                  // 14
      if (data == null)                                                                                   // 15
        data = {};                                                                                        // 16
      return x.apply(data, arguments);                                                                    // 17
    };                                                                                                    // 18
  }                                                                                                       // 19
  return x;                                                                                               // 20
};                                                                                                        // 21
                                                                                                          // 22
var wrapHelper = function (f) {                                                                           // 23
  return Blaze.wrapCatchingExceptions(f, 'template helper');                                              // 24
};                                                                                                        // 25
                                                                                                          // 26
// !!! FIX THIS COMMENT !!!                                                                               // 27
//                                                                                                        // 28
// Implements {{foo}} where `name` is "foo"                                                               // 29
// and `component` is the component the tag is found in                                                   // 30
// (the lexical "self," on which to look for methods).                                                    // 31
// If a function is found, it is bound to the object it                                                   // 32
// was found on.  Returns a function,                                                                     // 33
// non-function value, or null.                                                                           // 34
//                                                                                                        // 35
// NOTE: This function must not establish any reactive                                                    // 36
// dependencies.  If there is any reactivity in the                                                       // 37
// value, lookup should return a function.                                                                // 38
Blaze.View.prototype.lookup = function (name, _options) {                                                 // 39
  var template = this.template;                                                                           // 40
  var lookupTemplate = _options && _options.template;                                                     // 41
                                                                                                          // 42
  if (/^\./.test(name)) {                                                                                 // 43
    // starts with a dot. must be a series of dots which maps to an                                       // 44
    // ancestor of the appropriate height.                                                                // 45
    if (!/^(\.)+$/.test(name))                                                                            // 46
      throw new Error("id starting with dot must be a series of dots");                                   // 47
                                                                                                          // 48
    return Blaze._parentData(name.length - 1, true /*_functionWrapped*/);                                 // 49
                                                                                                          // 50
  } else if (template && (name in template)) {                                                            // 51
    return wrapHelper(bindDataContext(template[name]));                                                   // 52
  } else if (lookupTemplate && Template.__lookup__(name)) {                                               // 53
    return Template.__lookup__(name);                                                                     // 54
  } else if (UI._globalHelpers[name]) {                                                                   // 55
    return wrapHelper(bindDataContext(UI._globalHelpers[name]));                                          // 56
  } else {                                                                                                // 57
    return function () {                                                                                  // 58
      var isCalledAsFunction = (arguments.length > 0);                                                    // 59
      var data = Blaze.getCurrentData();                                                                  // 60
      if (lookupTemplate && ! (data && data[name])) {                                                     // 61
        throw new Error("No such template: " + name);                                                     // 62
      }                                                                                                   // 63
      if (isCalledAsFunction && ! (data && data[name])) {                                                 // 64
        throw new Error("No such function: " + name);                                                     // 65
      }                                                                                                   // 66
      if (! data)                                                                                         // 67
        return null;                                                                                      // 68
      var x = data[name];                                                                                 // 69
      if (typeof x !== 'function') {                                                                      // 70
        if (isCalledAsFunction) {                                                                         // 71
          throw new Error("Can't call non-function: " + x);                                               // 72
        }                                                                                                 // 73
        return x;                                                                                         // 74
      }                                                                                                   // 75
      return x.apply(data, arguments);                                                                    // 76
    };                                                                                                    // 77
  }                                                                                                       // 78
  return null;                                                                                            // 79
};                                                                                                        // 80
                                                                                                          // 81
// Implement Spacebars' {{../..}}.                                                                        // 82
// @param height {Number} The number of '..'s                                                             // 83
Blaze._parentData = function (height, _functionWrapped) {                                                 // 84
  var theWith = Blaze.getCurrentView('with');                                                             // 85
  for (var i = 0; (i < height) && theWith; i++) {                                                         // 86
    theWith = Blaze.getParentView(theWith, 'with');                                                       // 87
  }                                                                                                       // 88
                                                                                                          // 89
  if (! theWith)                                                                                          // 90
    return null;                                                                                          // 91
  if (_functionWrapped)                                                                                   // 92
    return function () { return theWith.dataVar.get(); };                                                 // 93
  return theWith.dataVar.get();                                                                           // 94
};                                                                                                        // 95
                                                                                                          // 96
                                                                                                          // 97
Blaze.View.prototype.lookupTemplate = function (name) {                                                   // 98
  return this.lookup(name, {template:true});                                                              // 99
};                                                                                                        // 100
                                                                                                          // 101
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//# sourceMappingURL=cf9aea283fb9b9d61971a3b466bff429f9d66d7d.map
