...
_.extend(Meteor, {                                                                                  // 11
  ...
  _inherits: function (Child, Parent) {                                                             // 121
    // copy Parent static properties                                                                // 122
    for (var key in Parent) {                                                                       // 123
      // make sure we only copy hasOwnProperty properties vs. prototype                             // 124
      // properties                                                                                 // 125
      if (_.has(Parent, key))                                                                       // 126
        Child[key] = Parent[key];                                                                   // 127
    }                                                                                               // 128
                                                                                                    // 129
    // a middle member of prototype chain: takes the prototype from the Parent                      // 130
    var Middle = function () {                                                                      // 131
      this.constructor = Child;                                                                     // 132
    };                                                                                              // 133
    Middle.prototype = Parent.prototype;                                                            // 134
    Child.prototype = new Middle();                                                                 // 135
    Child.__super__ = Parent.prototype;                                                             // 136
    return Child;                                                                                   // 137
  }                                                                                                 // 138
});                                                                                                 // 139
                                                                                                    // 140
...
//# sourceMappingURL=47d1d2b71177463dc159606cf930e44b9e3337f6.map
